...
export default function EditNote({ note, curentUser }) {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .put(
                "/api/users/" + curentUser.id + "/notes/" + note.id,
                editedNote
            )
            .then((response) => {
                    ...
                    <div className="form-content">
                        <div className="inputs">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    (editedNote.name = e.target.value)
                                }
                            />
                            <label>Subject</label>
                            <input
                                ...
                                onChange={(e) =>
                                    (editedNote.subject = e.target.value)
                                }
                            />
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    (editedNote.activityType = e.target.value)
                                }
                            />
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    (editedNote.activityNumber = e.target.value)
                                }
                            />
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    (editedNote.activityDate = e.target.value)
                                }
                            />
                        </div>
                        <textarea
